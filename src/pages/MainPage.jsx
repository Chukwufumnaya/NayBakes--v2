...
function FlippableCard({ item }) {
  ...
  return (
    ...
    <div
      className={`bg-[#D5C4A1] p-8 py-5 w-[270px] h-[280px] cursor-pointer [perspective:1000px] group rounded-xl shadow m-auto`}
      onClick={handleFlip}
    >
      {isMobile && !flipped && (
        <div
...
export default function MainPage() {
  ...
  const customerReviews = reviews.map(review => (
    <div key={review.id} className="p-5 w-[250px] h-[230px] flex flex-col justify-center items-center text-xs">
      <img
        src={review.avatar}
        alt="avatar"
        loading="lazy"
      ...
      <main>
        ...
        <section className="mt-6 text-center">
          <HashLink to="/menu#menu">
            <button className="bg-[#D5C4A1] p-3 rounded-3xl text-sm sm:text-lg cursor-pointer hover:bg-[#9b8e73]">Click to view our menu and place your order.</button>
          </HashLink>
        </section>
